/*!
聽* jRaiser 2 Javascript Library
聽* Yaolongfei - v1.0.0 (2015-07-28T17:30:00+0800)
聽*/
...
/**
聽* 鐢ㄤ簬浼楃涓汉涓績宸︿晶绔栧瀷鑿滃崟鐨勫姩鎬佹牱寮忓垏鎹�
聽* @method listClick
聽* @for 鏃�
聽* @param {int} value 鏍囪鎵€鐐瑰嚮鐨勮彍鍗�
聽* @return {null} 鏃�
聽*/
function listClick(value){
	...
	if(value == 4){
		...
		$("#crowdfunding_iframe").attr("src","crowdfunding.center/reset-pwd.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
